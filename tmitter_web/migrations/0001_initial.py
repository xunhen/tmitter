    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tmitter_web.Category', verbose_name='来源')),
            ],
            options={
                'verbose_name': '消息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tmitter_web.Area', verbose_name='地区')),
                ('friend', models.ManyToManyField(related_name='_user_friend_+', to='tmitter_web.User', verbose_name='朋友')),
            ],
            options={
                'verbose_name': '用户',
        ...
        migrations.AddField(
            model_name='note',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tmitter_web.User', verbose_name='发布者'),
        ),
    ]
