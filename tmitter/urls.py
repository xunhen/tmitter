...
# Example:
    ...
    url(r'^p/?P<_page_index>(\d+)/$',tmitter_web.views.index_page),
...
#    url(r'^user/(?P<_username>[a-zA-Z\-_\d]+)/$',tmitter.tmitter_web.views.index_user, name= "tmitter-mvc-views-index_user"),
    url(r'^user/?P<_username>([a-zA-Z\-_\d]+)/$',tmitter_web.views.index_user, name= "tmitter-mvc-views-index_user"),
    url(r'^user/?P<_username>([a-zA-Z\-_\d]+)/?P<_page_index>(\d+)/$',tmitter_web.views.index_user_page),
    url(r'^users/$',tmitter_web.views.users_index),
    url(r'^users/?P<_page_index>(\d+)/$',tmitter_web.views.users_list),
    ...
    url(r'^message/?P<_id>(\d+)/$',tmitter_web.views.detail, name = "tmitter-mvc-views-detail"),
    url(r'^message/?P<_id>(\d+)/delete/$',tmitter_web.views.detail_delete, name = "tmitter-mvc-views-detail_delete"),
    url(r'^friend/add/?P<_username>([a-zA-Z\-_\d]+)',tmitter_web.views.friend_add, name="tmitter-mvc-views-friend_add"),
    url(r'^friend/remove/?P<_username>([a-zA-Z\-_\d]+)',tmitter_web.views.friend_remove),
